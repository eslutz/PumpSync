...
- App Store subscription transaction identifiers and entitlement status when the user chooses PumpSync Hosted.
- A PumpSync installation identifier generated by the app.
...
- App Store subscription entitlement state for hosted users;
