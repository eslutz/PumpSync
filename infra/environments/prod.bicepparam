...
param resourceGroupName = readEnvironmentVariable('AZURE_RESOURCE_GROUP', 'rg-pumpsync-prod')
param appleClientId = readEnvironmentVariable('APPLE_CLIENT_ID', 'dev.ericslutz.PumpSync')
